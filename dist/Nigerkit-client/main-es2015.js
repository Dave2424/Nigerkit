...
const routes = [
    ...
    { path: 'shop', component: _pages_shop_shop_component__WEBPACK_IMPORTED_MODULE_5__["ShopComponent"], resolve: { allProduct: _resolvers_shop_resolver__WEBPACK_IMPORTED_MODULE_4__["ShopResolve"] } },
    { path: 'product/:slug', component: _pages_products_products_component__WEBPACK_IMPORTED_MODULE_14__["ProductsComponent"], resolve: { relateDetails: _resolvers_product_resolver__WEBPACK_IMPORTED_MODULE_15__["ProductDetailsResolve"] } },
    { path: 'cart', component: _pages_cart_cart_component__WEBPACK_IMPORTED_MODULE_16__["CartComponent"] },
    { path: 'checkout', component: _pages_checkout_checkout_component__WEBPACK_IMPORTED_MODULE_17__["CheckoutComponent"], canActivate: [_guards_checkout_guard__WEBPACK_IMPORTED_MODULE_18__["CheckOutGuard"]] },
    ...
    { path: 'blog', component: _pages_blog_blog_component__WEBPACK_IMPORTED_MODULE_9__["BlogComponent"], resolve: { blogdetails: _resolvers_blog_resolver__WEBPACK_IMPORTED_MODULE_8__["BlogResolve"] } },
    { path: 'blog/:slug', component: _pages_blog_post_post_component__WEBPACK_IMPORTED_MODULE_7__["PostComponent"], resolve: { details: _resolvers_blogdetails_resolver__WEBPACK_IMPORTED_MODULE_6__["BlogDetailsResolve"] } },
    { path: 'category/:slug', component: _pages_category_category_component__WEBPACK_IMPORTED_MODULE_3__["CategoryComponent"], resolve: { categorydetails: _resolvers_category_resolver__WEBPACK_IMPORTED_MODULE_2__["CategoryProductResolve"] } },
    // otherwise redirect to home
    { path: '404', component: _pages_page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_1__["PageNotFoundComponent"] },
    { path: '**', redirectTo: '/404' },
...
AppRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_11__["NgModule"])({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_12__["RouterModule"].forRoot(routes, { preloadingStrategy: _angular_router__WEBPACK_IMPORTED_MODULE_12__["PreloadAllModules"] })],
...
let ShopComponent = class ShopComponent {
    ...
    checkItemInCart(product) {
        ...
        if (this.cart) {
            if (this.currentUser) {
                for (let i = 0; i < this.count(this.cart); i++) {
                    let search = lodash__WEBPACK_IMPORTED_MODULE_7__["findLast"](this.cart, ["id", product.id]);
                    // console.log(search);
                    if (search)
                        result = true;
                    else
...
/* harmony import */ var _helpers_must_match__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../helpers/must-match */ "./src/app/helpers/must-match.ts");
...
let AuthenticationService = class AuthenticationService {
    ...
    login(email, password) {
        return this.http.post(`${this.endPointAuth}/login`, { email, password });
    }
    // Register a new user
    createUser(formData) {
...
let BaseService = class BaseService {
    ...
    googleSearchPlaces(query) {
        return this.http.post(`${this.endpoint}/address-search-places`, { query: query }).pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(8000));
    }
    // Update user profile
    update(formData) {
