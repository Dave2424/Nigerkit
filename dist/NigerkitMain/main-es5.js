(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsSkeletonloaderSkeletonloaderComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsSkeletonloaderSkeletonloaderComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsSkeletonloaderSkeletonloaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    SkeletonloaderComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      /*! raw-loader!./skeletonloader.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/Components/skeletonloader/skeletonloader.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./skeletonloader.component.css */
      "./src/app/Components/skeletonloader/skeletonloader.component.css")).default]
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    const routes = [// {path: '', loadChildren: './pages/home/home.component#HomeComponent'},
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("spinnerElement", {
      static: true
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ngx_skeleton_loader__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(
    /*! ngx-skeleton-loader */
    "./node_modules/ngx-skeleton-loader/fesm2015/ngx-skeleton-loader.js");
    /* harmony import */


    var _Components_skeletonloader_skeletonloader_component__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(
    /*! ./Components/skeletonloader/skeletonloader.component */
    "./src/app/Components/skeletonloader/skeletonloader.component.ts");
  ...
  function srcAppPagesBlogBlogComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let BlogComponent = class BlogComponent {
      ...
      ngOnInit() {
        this.blogs = this.route.snapshot.data.blogdetails.post; // console.log(this.blogs);
  ...
  function srcAppPagesCartCartComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let CartComponent = class CartComponent {
      ...
      ngOnInit() {// this.checkItems();
      }

      checkItems() {
        if (this.currentUser) {
          // user cart items
          this.cartSubscription = this.storeService.GetCartItems(this.currentUser.id).subscribe(items => {
            if (this.count(items) > 0) this.cart = items; // console.log(this.cart);
          });
        } else {
          if (this.count(this.getSavedCartInStorage()) > 0) this.cart = this.getSavedCartInStorage();
        }
      }
      ...
      removeFromCart(item) {
        ...
        if (this.currentUser) {
          this.storeService.RemoveFromCart(item.product_id, this.currentUser.id).subscribe(data => {
            console.log(data); // var cartsend = localStorage.setItem("cart_Items", JSON.stringify(data));
    ...
    let CategoryComponent = class CategoryComponent {
      ...
      checkItems() {
        if (this.currentUser) {
          ...
          if (this.count(this.getSavedCartInStorage()) > 0) // this.cart.push(this.getSavedCartInStorage());
            this.cart = this.getSavedCartInStorage();
        }
      } // Navigation
  ...
  function srcAppPagesCheckoutCheckoutComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let CheckoutComponent = class CheckoutComponent {
      ...
      ngOnInit() {
        this.cart = JSON.parse(localStorage.getItem("cart_Items")); // this.userData.fname = this.currentUser.fname ? this.currentUser.fname : "";
      ...
      calculateDeliveryFee() {
        ...
        this.storeService.CalculateDelivery(formData).subscribe(resp => {
          this.loading = false;
          this.proceed = true; // console.log(resp);
      ...
      transactionSuccessful(event) {
        ...
        let address = this.currentUser.address; // this.processingOrder = true;
  ...
  function srcAppPagesShopShopComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let ShopComponent = class ShopComponent {
      constructor(route, router, alert, postservice, storeService, authenticationservice) {
        ...
        this.authenticationservice.currentUser.subscribe(x => this.currentUser = x);
        this.checkItems(); // console.log('this is the Shop');
      }

      ngOnInit() {
        this.products = this.route.snapshot.data.allProduct.products; // this.checkItems();
      ...
      saveToSession(data) {
        if (this.count(this.getSavedCartInStorage()) === 0) {
          ...
          // check is item already exists
          let cartItems = this.getSavedCartInStorage(); // console.log(cartItems);
  ...
  function srcAppPagesSignupSignupComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _helpers_must_match__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../helpers/must-match */
    "./src/app/helpers/must-match.ts");
    /* harmony import */
    ...
    let SignupComponent = class SignupComponent {
      ...
      onLogin() {
        ...
        this.lloading = true;
        this.authenticationService.login(this.l.email.value, this.l.pwd.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["first"])()).subscribe(data => {
          // console.log(data);
          if (data.user.email_verified_at) {
            this.handleResponse(data);
            this.lloading = false;
          } else {
            this.l_error = "Your email is not verified. Please verify your email";
            this.lloading = false;
          }
        }, error => {
          // console.log(error);
          this.l_error = error; // console.log(error);
      ...
      onSubmit() {
        ...
        this.loading = true;
        this.authenticationService.createUser(this.registrationForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["first"])()).subscribe(data => {
          this.loading = false;
          this.submitted = false;
          this.alert.snotSimpleSuccess(data.message);
          this.router.navigateByUrl("/");
    ...
    SignupComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["Component"])({
      selector: "app-signup",
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
  ...
  function srcAppServicesAuthenticationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AuthenticationService = class AuthenticationService {
      ...
      logout() {
        ...
        this.removeToken();
        this.currentUserSubject.next(null); // this.cartItemSubject.next([]);
      }
  ...
  function srcAppServicesBaseServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let BaseService = class BaseService {
      ...
      getFooterDetails() {
        return this.http.get("".concat(this.endpoint, "/get-footer-details"));
      }
      ...
      getStates() {
        return this.http.get("".concat(this.endpoint, "/get-states"));
      }
  ...
  function srcAppServicesStoreServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let StoreService = class StoreService {
      ...
      GetCartItems(user_id) {
        return this.http.get("".concat(this.endpoint, "/store/store-get-cart/").concat(user_id));
      }
      ...
      RemoveFromCart(item_id, user_id) {
        return this.http.get("".concat(this.endpoint, "/store/store-remove-from-cart/").concat(item_id, "/").concat(user_id));
      }
  ...
  function srcAppSharedFooterFooterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_base_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    let FooterComponent = class FooterComponent {
      ...
      onSubmit() {
        ...
        this.baseservice.addSubscriber(this.f.email.value).subscribe(item => {
          this.loading = false;
          if (item.message) this.alert.infoMsg(item.message, "Notice");else this.alert.infoMsg(item.error, "Notice");
        }, error => {
          this.error = error;
          this.loading = false;
        });
  ...
  function srcAppSharedHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let HeaderComponent = class HeaderComponent {
      ...
      updateLocalCart() {
        localStorage.setItem("cart_Items", JSON.stringify(this.cart));
        this.authenticationservice.setCartItems(this.cart); // console.log("subscription clicked");
      }
